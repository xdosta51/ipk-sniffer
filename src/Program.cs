           ...
           /*priradi zarizeni zvolene zarizeni */
            ...
            {   
                try {
                    ...
                    var eth = ((PacketDotNet.EthernetPacket)packet_parse);
                    
                    /*preklad source a destip z paketu + zjisteni zda se jedna o tcp nebo udp paket */
                    string sourceip = eth.SourceHardwareAddress.ToString();
                    string destip = eth.DestinationHardwareAddress.ToString();
                    ...
                    string srcip = ipv4pak.SourceAddress.ToString();
                    string dstip = ipv4pak.DestinationAddress.ToString();
                    
                    
                    /*zachytavani prekladu na domenu pokud neprojde pouzije se ip */
                    try {
                    ...
                    try {
                        IPHostEntry localboy = Dns.GetHostEntry(srcip);
                        srcip = localboy.HostName;
                    }
                    catch {
                    }
